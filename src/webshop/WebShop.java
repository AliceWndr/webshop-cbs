...
public class WebShop {
	...
	public static void newCustomer(Scanner input) throws ParseException {
	...
	public static void checkoutScreen(Customer c, ArrayList<Product> productList, Scanner input) throws ParseException {
		...
		if (choice == 1) {
			...
			System.out.println("Should we ship to your default address? 1 - Yes, 2 - No\n");
			...
			System.out.println("\nPlease, enter your card details as the system prompts you!\n");
